...
Perché questa soluzione funziona molto meglio di un semplice testo scritto:
Effetto "Sorgente" (Backdrop blur): Lo sfondo della pagina dietro al banner si sfuoca leggermente, attirando in modo perentorio l'attenzione del collega solo sul testo del diniego.

Nessuna distrazione: L'utente non può cliccare altrove nella pagina finché non prende una decisione sui due tasti del banner.

Tutela logistica: Avendo cliccato espressamente su un pulsante con scritto "Ho compreso e accetto le condizioni", l'utente non potrà più usare la scusa del "Io non lo sapevo" in caso di contestazioni o di rifiuto d'accesso al cancello da parte dei verificatori.
// ============================================================
// ⚙️ GESTIONE PULSANTI INTERNI AL BANNER DI CONFERMA
// ============================================================
